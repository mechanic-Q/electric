...
```markdown
Read /mnt/e/Ellectric/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /mnt/e/Ellectric/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /mnt/e/Ellectric/.claude/agents/gsd-ui-checker.md for instructions.
