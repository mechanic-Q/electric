...
<reference>
@/mnt/e/Ellectric/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/mnt/e/Ellectric/.opencode/get-shit-done/references/user-profiling.md` to load:
