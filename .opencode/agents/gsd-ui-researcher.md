...
Use template from `/mnt/e/Ellectric/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/mnt/e/Ellectric/.opencode/get-shit-done/templates/UI-SPEC.md`
