...
See /mnt/e/Ellectric/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /mnt/e/Ellectric/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /mnt/e/Ellectric/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /mnt/e/Ellectric/.claude/get-shit-done/templates/discovery.md
...
Use /mnt/e/Ellectric/.claude/get-shit-done/templates/discovery.md.
