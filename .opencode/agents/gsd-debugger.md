...
<required_reading>
@/mnt/e/Ellectric/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/mnt/e/Ellectric/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /mnt/e/Ellectric/.opencode
                  → checks /mnt/e/Ellectric/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /mnt/e/Ellectric/.opencode/get-shit-done
                  → writes to /mnt/e/Ellectric/.opencode/get-shit-done/hooks/
...
@/mnt/e/Ellectric/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/mnt/e/Ellectric/.opencode/get-shit-done/references/common-bug-patterns.md
