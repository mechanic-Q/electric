...
<!-- For checkpoint task examples and patterns, see @/mnt/e/Ellectric/.claude/get-shit-done/references/checkpoints.md -->
...
See `/mnt/e/Ellectric/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/mnt/e/Ellectric/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/mnt/e/Ellectric/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
