...
Reference full template: `/mnt/e/Ellectric/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/mnt/e/Ellectric/.opencode/get-shit-done/templates/state.md`.
