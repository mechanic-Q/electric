...
```markdown
Read /mnt/e/Ellectric/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /mnt/e/Ellectric/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /mnt/e/Ellectric/.opencode/agents/gsd-ui-checker.md for instructions.
