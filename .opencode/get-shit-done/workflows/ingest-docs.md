...
```bash
INIT=$(node "/mnt/e/Ellectric/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/mnt/e/Ellectric/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
