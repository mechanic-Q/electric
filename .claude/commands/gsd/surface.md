...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/mnt/e/Ellectric/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/mnt/e/Ellectric/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/mnt/e/Ellectric/.claude/commands/gsd
AGENTS_DIR=/mnt/e/Ellectric/.claude/agents
```
...
<execution_context>
Surface state file: `/mnt/e/Ellectric/.claude/skills/.gsd-surface.json`
Install profile marker: `/mnt/e/Ellectric/.claude/skills/.gsd-profile`
Engine module: `/mnt/e/Ellectric/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/mnt/e/Ellectric/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
