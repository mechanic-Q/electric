...
<required_reading>
@/mnt/e/Ellectric/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/mnt/e/Ellectric/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /mnt/e/Ellectric/.claude
                  → checks /mnt/e/Ellectric/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /mnt/e/Ellectric/.claude/get-shit-done
                  → writes to /mnt/e/Ellectric/.claude/get-shit-done/hooks/
...
@/mnt/e/Ellectric/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/mnt/e/Ellectric/.claude/get-shit-done/references/common-bug-patterns.md
