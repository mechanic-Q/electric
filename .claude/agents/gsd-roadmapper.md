...
Reference full template: `/mnt/e/Ellectric/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/mnt/e/Ellectric/.claude/get-shit-done/templates/state.md`.
