...
```
Agent(
  prompt="Read /mnt/e/Ellectric/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/mnt/e/Ellectric/.claude/get-shit-done/templates/VALIDATION.md`
